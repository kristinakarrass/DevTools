...
var params = { width: 2000, height: 400 };
...
// var ellipse = two.makeEllipse(250, 200, 50, 100);
var triangle = two.makePolygon(100, 100, 100, 3);
var triangle2 = two.makePolygon(100, 100, 10, 3);
// var rect1 = two.makeRectangle(250, 100, 25, 160);
...
// var rect10 = two.makeRectangle(1250, 167, 100, 20);
...
// var line2 = two.makeLine(1300, 160, 1450, 80);
...
//   if (underlineGroup.scale > 0.9999 && two.frameCount < 5) {
//     underlineGroup.scale = underlineGroup.rotation = 0;
//   }
//   var t = (1 - underlineGroup.scale) * 0.125;
//   underlineGroup.scale += t;
//   underlineGroup.rotation += t * 4 * Math.PI;
// }).play(); 
